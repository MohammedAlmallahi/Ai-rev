...
function AiBenefits() {
  return (
      <section id='benefits' className='app-container py- bg-linear-to-br from-dark to-gray-900 rounded-3xl text-white sm:m-4 lg:m-auto p-6 items-center pb-8'>
      <div className='text-center mb-12'>
        <span className=' section-subheader text-xl'>AI Benefits</span>
        <h2 className='section-header'>
          Unlock the Power of {""} 
          <span className=' gradient-text'>Artificial Intelligence</span>
        </h2>
          <p className='section-description text-gray-300'>
            Explore the transformative benefits of AI across industries and how it's shaping our future.
          </p>
      </div>
