...
function HeroSections() {
  return (
    ...
    <div className='space-y-6'>
      <h1 className=' text-4xl md:text-5xl lg:text-6xl font-bold leading-tight'>
        ...
        for a Smarter Future
            ...
            <p className="text-lg text-gray-600 max-w-lg">Discover how AI is transforming industries and improving lives
    ...
    <img src='https://images.unsplash.com/photo-1674027444485-cec3da58eef4?q=80&w=1932&auto=format&fit=crop' className=' w-full h-full object-cover rounded-2xl' alt='hero section'/>
          <div className="absolute w-32 h-32 rounded-full bg-secondary/20 -bottom-6 -left-6 blur-xl"></div>
          <div className="absolute w-32 h-32 rounded-full bg-accent/20 -top-4 -right-4 blur-2xl"></div>
    </div>
    </div>
    </section>
  )
